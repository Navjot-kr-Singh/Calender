...
export default function WallCalendar() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto min-h-screen p-4 sm:p-6 lg:p-8 flex items-center justify-center font-sans tracking-normal relative">
      <div className="absolute top-4 right-4 z-50 flex items-center gap-2">
        <ThemeToggle />
        <UserButton />
      </div>

      <div className="bg-white dark:bg-stone-900 rounded-2xl shadow-calendar w-full max-w-6xl mx-auto flex flex-col md:flex-row overflow-hidden border border-stone-200/60 dark:border-stone-700/60 ring-1 ring-black/5 dark:ring-white/5">
